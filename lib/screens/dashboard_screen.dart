              ...
              child: Column(
                  ...
                  children: [
                    ...
                    _TodayCard(
                      ...
                      streak: streak,
                      emojiMap: _emojiMap,
                      onLogMood: () => Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (_) => EmotionTrackingScreen(
                    ...
                    const Text('Self Care Activities',
                        style: TextStyle(
                            fontSize: 18,
                            fontWeight: FontWeight.w800,
                            color: AppColors.textDark)),
                      ...
                      _QuickAction(
                          ...
                          onTap: () {
                            const a = RecommendedActivity(
                                ...
                                durationMinutes: 5,
                                description:
                                    'Inhale 4s, hold 4s, exhale 4s, hold 4s. Repeat to calm your nervous system.');
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (_) =>
                                        const ActivityScreen(activity: a)));
                          }),
                      ...
                      _QuickAction(
                          ...
                          onTap: () {
                            const a = RecommendedActivity(
                                ...
                                durationMinutes: 5,
                                description:
                                    'A gentle meditation to check in with your body and release tension.');
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (_) =>
                      ...
                      _QuickAction(
                          ...
                          onTap: () {
                            const a = RecommendedActivity(
                                ...
                                durationMinutes: 3,
                                description:
                                    'Reinforce your well-being with uplifting statements. Read each one slowly and let it sink in.');
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (_) =>
...
class _VertDivider extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
      width: 1,
      height: 40,
      color: AppColors.textMedium.withValues(alpha: 0.25));
}
        ...
        itemBuilder: (_, i) {
          ...
          return Container(
            ...
            child:
              ...
              Icon(b.icon,
                  size: 26, color: b.unlocked ? b.color : Colors.grey.shade400),
              ...
              Text(b.title,
                  ...
                  style: TextStyle(
                      fontSize: 10,
                      fontWeight: FontWeight.w600,
                      color: b.unlocked ? AppColors.textDark : Colors.grey,
                      height: 1.2)),
            ]),
          );
        },
          ...
          ? Row(children: [
              ...
              Expanded(
                  child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                    Text("You're feeling ${mood.emotionType}",
                        style: const TextStyle(
                            fontSize: 17,
                            fontWeight: FontWeight.w800,
                            color: AppColors.textDark)),
    ...
    switch (type) {
      case 'mood_log':
        return _HistoryItemData(
            ...
            color: const Color(0xFF42A5F5),
            title: 'Mood Logged',
            subtitle: '+${h.pointsEarned} pts',
            time: _timeAgo(h.achievementTimestamp));
      case 'activity':
        final act = h.metadata['activity'] as String? ?? h.achievement;
        return _HistoryItemData(
            icon: Icons.spa,
            color: const Color(0xFF66BB6A),
            title: act.replaceAll('Activity Completed: ', ''),
            subtitle: '+${h.pointsEarned} pts',
            time: _timeAgo(h.achievementTimestamp));
      case 'milestone':
      case 'streak':
      ...
      default:
        return _HistoryItemData(
            ...
            color: AppColors.primary,
            title: h.achievement,
            subtitle: h.pointsEarned > 0 ? '+${h.pointsEarned} pts' : '',
            time: _timeAgo(h.achievementTimestamp));
    }
  }
    ...
    if (history.isEmpty) {
      return Container(
        ...
        child: const Center(
          ...
          Text('Start logging moods or doing activities!',
