...
class _AvatarStoreScreenState extends State<AvatarStoreScreen> {
  ...
  final List<Map<String, dynamic>> _availableAvatars = [
    ...
    {'id': 'bear', 'emoji': '🐻', 'name': 'Brave Bear', 'cost': 350},
    {'id': 'panda', 'emoji': '🐼', 'name': 'Peaceful Panda', 'cost': 500},
    {'id': 'lion', 'emoji': '🦁', 'name': 'Courageous Lion', 'cost': 700},
    {'id': 'butterfly', 'emoji': '🦋', 'name': 'Gentle Butterfly', 'cost': 950},
    {'id': 'turtle', 'emoji': '🐢', 'name': 'Patient Turtle', 'cost': 1250},
    {'id': 'dolphin', 'emoji': '🐬', 'name': 'Playful Dolphin', 'cost': 1600},
    {'id': 'deer', 'emoji': '🦌', 'name': 'Graceful Deer', 'cost': 2000},
    {'id': 'koala', 'emoji': '🐨', 'name': 'Restful Koala', 'cost': 2500},
    {'id': 'hedgehog', 'emoji': '🦔', 'name': 'Cozy Hedgehog', 'cost': 3100},
    {'id': 'swan', 'emoji': '🦢', 'name': 'Serene Swan', 'cost': 3800},
    {'id': 'otter', 'emoji': '🦦', 'name': 'Cheerful Otter', 'cost': 4600},
  ];
